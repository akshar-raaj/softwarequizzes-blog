...
BLOG_AUTHOR = "Akshar Raaj"  # (translatable)
BLOG_TITLE = "Software Quizzes"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://softwarequizzes.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://softwarequizzes.com/"
BLOG_EMAIL = "raaj.akshar@gmail.com"
BLOG_DESCRIPTION = "Evaluate your skills and knowledge in SQL, Python, JavaScript, Linux, Docker and more!"  # (translatable)
